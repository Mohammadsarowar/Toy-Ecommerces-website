...
const ReviewPage = () => {
  return (
    <div>  <h1 className="text-2xl text-center mt-8 font-bold mb-4">Product Reviews</h1>
      {" "}
      <div className=" grid gap-10 text-center mx-auto grid-cols-3 items-center justify-center py-8">
        ...
        <div className="max-w-md bg-white rounded-lg shadow-md px-4 py-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              />
              <div>
                <p className="text-gray-800 font-bold">sarowar </p>
                <p className="text-gray-600">May 15, 2020</p>
              </div>
            </div>
            <div className="flex items-center">
              <svg
